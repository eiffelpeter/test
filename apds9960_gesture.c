...
#define READ_FIFO_TIMEOUT_MS                                                                                                                                   \
    30 // after check scope, the next interrupt usually come in 20ms.
...
int main(int argc, char **argv) {
    ...
    enable_apds9960_gesture("/sys/bus/iio/devices/iio:device0/scan_elements/in_proximity1_en", true);
    enable_apds9960_gesture("/sys/bus/iio/devices/iio:device0/scan_elements/in_proximity2_en", true);
    enable_apds9960_gesture("/sys/bus/iio/devices/iio:device0/scan_elements/in_proximity3_en", true);
    enable_apds9960_gesture("/sys/bus/iio/devices/iio:device0/scan_elements/in_proximity4_en", true);
    enable_apds9960_gesture("/sys/bus/iio/devices/iio:device0/buffer/enable", true);
    ...
    if (fd != -1) {
        ...
        enable_apds9960_gesture("/sys/bus/iio/devices/iio:device0/buffer/enable", false);
        close(fd);
        return 0;
    } else {
        printf("open fail \n");
